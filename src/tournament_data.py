...
def init_tables(num_tables) -> dict:
    """
    Initialize tables.

    """
    table_ids = [chr(65 + i) for i in range(num_tables)]
    tables = {
        (table_id, side): {
...
def init_color_map(teams, num_teams) -> dict:
    """
    ...
    for i, team_id in enumerate(teams):
        hue = ((i / num_teams) * 0.618033988749895) % 1.0  # Golden ratio
        saturation = 0.5
        value = 0.85
