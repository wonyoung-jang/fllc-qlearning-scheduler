...
class TimeData:
    ...
    def update_minimum_slots_required(self):
        ...
        self.minimum_slots_required = {
            KEY.JUDGING: self.calculate_minimum_slots_required(self.tournament_data.num_teams, self.tournament_data.num_rooms),
    ...
    def update_round_type_durations(self): 
        ...
        self.round_type_durations = {
            ...
            KEY.PRACTICE: round(self.available_practice_duration / self.minimum_slots_required[KEY.PRACTICE]),
            KEY.TABLE: round(self.available_table_duration / self.minimum_slots_required[KEY.TABLE]),
        }
    ...
    def create_round_type_time_slots(self): 
        ...
        self.round_type_time_slots = {
            KEY.JUDGING: self.calculate_end_times(self.judging_round_start_times, self.round_type_durations[KEY.JUDGING]),
